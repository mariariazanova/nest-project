...
describe('MetricsController', () => {
  ...
  describe('error scenarios', () => {
    ...
    it('should handle null response', async () => {
      jest.spyOn(metricsService, 'getMetrics').mockResolvedValue(null as unknown as string);
    ...
    it('should handle undefined response', async () => {
      jest.spyOn(metricsService, 'getMetrics').mockResolvedValue(undefined as unknown as string);
